<p align="center">
  <img src="./illustrations/logo.png" alt="logo" width="512">
</p>
...
2. Open command palette (`Ctrl+Shift+P`), run the `Package Control: Add Repository` command and enter `https://github.com/funcfusion/mc-dp-icons-sublime/tree/main`.
